      ...
      <div className="container p-4 md:p-8 flex md:flex-row flex-col justify-between">
          ...
          <div className="relative">
              ...
              <div className='mt-4 flex flex-row justify-center md:justify-start'>

                {
                  socialLinks.map((link, index) => (
                    ...
                    >
                        <Link href={link.url} target='_blank' > <Image src={link.img} className='w-[40px] h-[40px]' /> </Link>
                    </motion.div>
                  ))
                }
            ...
            <div className="absolute right-0 bottom-0">
              <Link href='/'> <BiSolidChevronUpCircle className="md:w-[33px] md:h-[33px] w-[24px] h-[24px]"/> </Link> 
            </div>    
          </div>  
